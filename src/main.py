from wellness_functions import add_goals, remove_goals, view_goals, mark_goals, weekly_score, body_weight, view_weight
...
while user_choice != "8":
    ...
    if(user_choice == "1"):
        ...
        body_weight(weight_file)
        
    elif(user_choice == "7"):
        view_weight(weight_file)
